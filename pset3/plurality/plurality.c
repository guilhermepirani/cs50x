...
bool vote(string name)
{
    // Iterates through each candidate to see if name matches, then add a vote
...
void print_winner(void)
{
    // TODO
    int winner = 0;
    // Updates the highest vote count
    ...
    // Print all candidates that match the highest vote count
